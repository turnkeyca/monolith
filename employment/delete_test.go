...
func TestDelete(t *testing.T) {
	...
	in := httptest.NewRequest(http.MethodDelete, fmt.Sprintf("/api/employment/%s", id.String()), nil)
	...
	assert.Equal(t, fmt.Sprintf("delete from employments where id = %s;", id), testQuery, "body")
}
