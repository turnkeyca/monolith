...
func TestPut(t *testing.T) {
	...
	assert.Equal(t, fmt.Sprintf("update employment set id=%s, user_id=%s, employer=, occupation=, duration=, additional_details=, annual_salary=0.00 where id=%s;", id, userId, id), testQuery, "body")
}
