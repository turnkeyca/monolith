...
func TestPut(t *testing.T) {
	...
	assert.Equal(t, fmt.Sprintf("update reference set id=%s, user_id=%s, full_name=, email=, phone_number=, relationship=,additional_details= where id=%s;", id, userId, id), testQuery, "body")
}
