...
func (o *UpdateUserParams) WithBody(body *models.UserDto) *UpdateUserParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update user params
func (o *UpdateUserParams) SetBody(body *models.UserDto) {
	o.Body = body
}

// WithToken adds the token to the update user params
func (o *UpdateUserParams) WithToken(token string) *UpdateUserParams {
	o.SetToken(token)
	return o
}

// SetToken adds the token to the update user params
func (o *UpdateUserParams) SetToken(token string) {
	o.Token = token
}
