...
// WithToken adds the token to the delete user params
func (o *DeleteUserParams) WithToken(token string) *DeleteUserParams {
	o.SetToken(token)
	return o
}

// SetToken adds the token to the delete user params
func (o *DeleteUserParams) SetToken(token string) {
	o.Token = token
}
