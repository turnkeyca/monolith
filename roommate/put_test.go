...
func TestPut(t *testing.T) {
	...
	assert.Equal(t, fmt.Sprintf("update roommate set id=%s, user_id=%s, roommate_user_id=, full_name=, email=, additional_details=$6 where id=%s;", id, userId, id), testQuery, "body")
}
